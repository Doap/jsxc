...
abstract class AbstractConnection {
   ...
   public sendMessage(message: Message) {
      ...
      let htmlMessage = this.getMessage(
         message,
         message.getEncryptedHtmlMessage,
      ...
      pipe
         ...
         .then(([message, xmlMsg]: [Message, Element]) => {
            if (
               ...
               !message.getAttachment().isProcessed()
            ) {
   ...
   public queryArchive(
      ...
      if (
         typeof beforeResultId === 'string' ||
         typeof beforeResultId === 'number'
      ) {
