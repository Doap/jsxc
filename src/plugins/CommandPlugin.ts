...
export default class CommandPlugin extends AbstractPlugin {
   ...
   private register() {
      ...
      const subjectChangeAction = async (
         args: string[],
      ...
      const affiliationChangeActionFactory = (
         affiliation: 'admin' | 'member' | 'owner' | 'none'
      ) => async (args: string[], contact: MultiUserContact) => {
         if (!contact.isGroupChat()) {
            throw new OnlyGroupChatError();
         }
      ...
      this.pluginAPI.registerCommand(
         '/admin',
         affiliationChangeActionFactory('admin'),
         'cmd_admin',
         'multiuser'
      );
      this.pluginAPI.registerCommand(
         '/member',
         affiliationChangeActionFactory('member'),
         'cmd_member',
         'multiuser'
      );
      this.pluginAPI.registerCommand(
         '/owner',
         affiliationChangeActionFactory('owner'),
         'cmd_owner',
         'multiuser'
      );
      this.pluginAPI.registerCommand(
         '/revoke',
         affiliationChangeActionFactory('none'),
         'cmd_revoke',
         'multiuser'
      );
      ...
      this.pluginAPI.registerCommand(
         '/moderator',
         roleChangeActionFactory('moderator'),
         'cmd_moderator',
         'multiuser'
      );
      this.pluginAPI.registerCommand(
